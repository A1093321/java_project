...
public abstract class A1093321_Project3_Agent
{
    ...
    private final ArrayList<A1093321_Project3_Artifact> ownedArtifacts = new ArrayList<>();
    
    public A1093321_Project3_Agent(int number)
    {
        this.number = number;
    ...
    public ArrayList<A1093321_Project3_Artifact> getOwnedArtifacts()
    {
        /********************************* TODO (Checkpoint 3) *********************************
    ...
    public int totalValue()
    {
        ...
        /************ START OF YOUR CODE ************/
        int tValue = 0;
        tValue = gemsInsideTent;
        for (int i = 0; i < ownedArtifacts.size(); i++) {
            tValue = gemsInsideTent + ownedArtifacts.get(i).getValue();
        }
    ...
    public final void act(A1093321_Project3_Environment environment)
    {
        if (this.inExploring)
        {
            String fileName = "";
